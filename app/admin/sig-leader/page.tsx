...
export default function ManageLeaderChooseSIG() {
  ...
  return isMobile ? (
    <div className="h-[calc(100dvh-8rem)] w-full overflow-y-auto bg-gradient-to-br from-indigo-50 to-purple-50 px-4 pt-4 pb-4">
      <div className="mx-auto max-w-md">
        ...
        {/* Title Card */}
        <div className="mb-6 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-500 p-5 text-white shadow-lg">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/20 text-2xl">
              👑
            </div>
            <div>
              <h2 className="font-bold text-lg">SIG Leader 管理</h2>
              ...
              .map((sig) => (
                ...
                >
                  {sig.avatar ? (
                    ...
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-indigo-100 to-purple-100 text-xl">
                      {sig.name.charAt(0)}
                    </div>
                  )}
    ...
    <div className="relative h-[calc(100%-6.5rem)] pt-5">
      ...
      <div className="flex h-full flex-col items-center justify-start">
        <h1 className="mb-4 font-bold text-3xl">SIG Leader 管理</h1>
