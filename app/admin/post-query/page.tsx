        ...
        <div className="overflow-auto h-full">
          <table className="w-full">
            <thead className="bg-gradient-to-r from-blue-500 to-blue-600 text-white sticky top-0">
              <tr>
                <th className="py-3 px-2 w-[15%] text-center font-semibold">ID</th>
                <th className="py-3 px-2 w-[50%] text-center font-semibold">標題</th>
                <th className="py-3 px-2 w-[15%] text-center font-semibold">作者</th>
                <th className="py-3 px-2 w-[20%] text-center font-semibold">建立時間</th>
              </tr>
            </thead>
